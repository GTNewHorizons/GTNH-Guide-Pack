...
navigation:
  ...
  title: 升级卡
  icon: appliedenergistics2:item.ItemMultiMaterial:28
item_ids:
...
查看 [基础卡](../items-blocks/upgrade_cards.md).
...
均分卡可应用于<ItemLink id="appliedenergistics2:tile.BlockCellWorkbench" />中的[存储元件](../items-blocks/storage_cells.md)，并根据卡片的分区将元件划分为大小相等的分区。这可以防止单一物品类型完全填满元件。
