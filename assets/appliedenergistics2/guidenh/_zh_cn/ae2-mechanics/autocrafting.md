...
3. **指令执行**  
   ME样板供应器根据[样板](../items-blocks/patterns.md)推送材料：
...
在<ItemLink id="appliedenergistics2:item.ItemMultiPart:340" />中用空白样板制作

### 四大样板类型

* **合成样板**  
  对应工作台配方，可直接插入<ItemLink id="appliedenergistics2:tile.BlockMolecularAssembler" />  
...
<ItemLink id="appliedenergistics2:item.ItemMultiPart:280" />+合成卡可创建"红石信号配方"：
- 不限定输入材料
- 收到指定物品即触发信号
- 适用于无限资源生产（如圆石复制机）
