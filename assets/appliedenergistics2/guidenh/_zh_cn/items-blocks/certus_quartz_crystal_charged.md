...
经<ItemLink id="appliedenergistics2:tile.BlockCharger" />处理的<ItemLink id="appliedenergistics2:item.ItemMultiMaterial:0" />。用于制作<ItemLink id="appliedenergistics2:item.ItemMultiMaterial:7" />和[赛特斯石英母岩](../items-blocks/budding_certus.md)。
