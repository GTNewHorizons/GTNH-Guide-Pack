...
Meteorites are the starting point for using AE2. Crucially, it has a <ItemLink id="appliedenergistics2:tile.BlockSkyChest" showIcon="true"/> in the center which may give you one of many inscribers.
